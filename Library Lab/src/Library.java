...
public class Library {
	...
	public void printAvailableBooks() {
		if (libraryBooks.isEmpty()) {
			System.out.println("This library has no books fit for mortal eyes.");
		} else {
	...
	public static void printOpeningHours() {
		System.out.println("The Library is never open. Do not go to the library. If you see a Librarian it is too late to flee.");
	}
