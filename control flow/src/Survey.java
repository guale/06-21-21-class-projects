...
public class Survey {
	...
	static void begin() {
		...
		String response = Flow.scan.next();
	...
	static int questionSix() {
		...
		do {
			...
			int modelYear = Flow.scan.nextInt();
